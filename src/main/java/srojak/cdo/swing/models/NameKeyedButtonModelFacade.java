 ...
 *
 */
public class NameKeyedButtonModelFacade
	 ...
	 * @param model
	 */
	public NameKeyedButtonModelFacade(NameToken tokenKey, ButtonModel model) {
		super(model);
	...
	protected String getNameIdentfier() {
		return "name=" + _tokenKey.getName();
	}
