 ...
 *
 */
public class NamedAndLabeledInt 
	...
	static {
		Class<?> classThis = NamedAndLabeledInt.class;
	 ...
	 * @param strLabel
	 */
	public NamedAndLabeledInt(String strName, String strLabel, int nValue) {
		super(strName, strLabel);
		_gateLock = new LockGate();
		_value = nValue;
	}
	
	public NamedAndLabeledInt(String strName, int nValue) {
		super(strName);
		_gateLock = new LockGate();
		_value = nValue;
	}
