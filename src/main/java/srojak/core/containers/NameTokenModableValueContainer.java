 ...
 *
 */
public class NameTokenModableValueContainer<V> 
		extends KeyModifiableValueContainer<NameToken, V>
	 ...
	 * @param value
	 */
	public NameTokenModableValueContainer(NameToken key, V value) {
		super(key, value);
		if (key.isRestricted()) {
