 ...
 *
 */
public class XmlStreamParserFactory<P extends XmlStreamParser> 
	 ...
	 * @param fnFactory
	 */
	public XmlStreamParserFactory(Class<P> classProduct, Supplier<P> fnFactory) {
		super(classProduct, fnFactory);
	}
