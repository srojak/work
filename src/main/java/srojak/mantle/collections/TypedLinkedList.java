 ...
 *
 */
public class TypedLinkedList<E>
	 ...
	 * 
	 */
	private static final long serialVersionUID = -9116345425768670032L;

	/**
	 * 
	 */
	public TypedLinkedList(Class<E> classElement) {
		super();
	 ...
	 * @param c
	 */
	public TypedLinkedList(Class<E> classElement, Collection<? extends E> c) {
		super(c);
		Objects.requireNonNull(classElement, "classElement");
		_classElement = classElement;
	}
