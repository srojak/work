 ...
 *
 */
public class ListModCounterTunnelTest {

	/**
	 * @param args
	 * requires JVM argument: --add-opens java.base/java.util=ALL-UNNAMED
	 */
	public static void main(String[] args) {
		UnitTestSeries series = new UnitTestSeries("TestListModCounter-Open");
