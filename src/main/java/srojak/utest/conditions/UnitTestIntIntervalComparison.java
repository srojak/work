...
public class UnitTestIntIntervalComparison
		extends UnitTestConditionIntBase {
	private final IntervalInt _interval;
	private final ConditionSense _sense;

	public UnitTestIntIntervalComparison(ConditionSense sense, IntervalInt interval) {
		super();
	...
	public boolean test(int actual) {
		return _sense.isExpectedResult(_interval.isInInterval(actual));
	}
